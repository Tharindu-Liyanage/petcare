    ...
    <head>
        ...
        <?php if($data['title'] == 'foodAndTreats'){ ?>
                ...
                <div class="category" id="dryfoods">
                    ...
                    <div class="small-category-title">Dry Foods</div>
                    ...
                    <div class="item-list">
                        <div class="item-card">
                            ...
                            <div class="item-title">bklabla bla</div>
                            <div class="item-price">$56.88</div>
                            <div class="buttons">
                ...
                <div class="category">
                    ...
                    <div class="small-category-title">Wet Foods</div>
        ...
        <?php if($data['title'] == 'groomingSupplies'){ ?>
            ...
            <div class="category">
                ...
                <div class="small-category-title">Brushes</div>
            ...
            <div class="category">
                ...
                <div class="small-category-title">Combs</div>
