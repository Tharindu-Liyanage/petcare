        ...
        <form class="container" >     <!--start of form-->
            ...
            <!-- ancor tag for each account setting -->
                <div class="setting-list">
                    ...
                    <a href="<?php echo URLROOT; ?>/assistant/settings/profile"> 
                    ...
                    <a href="<?php echo URLROOT; ?>/assistant/settings/password"> 
                    ...
                    <a href="<?php echo URLROOT; ?>/assistant/settings/email"> 
                    ...
                    <a href="<?php echo URLROOT; ?>/assistant/settings/mobile"> 
