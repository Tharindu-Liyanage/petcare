         ...
         <div class="header">
            <div class="left">
                ...
                <ul class="breadcrumb">
                    ...
                    <li> > </li> <!-- Include the ">" character within an <li> element -->
                    <li><a href="<?php echo URLROOT;?>/storemanager/addCategory" class="active">Add Category</a></li>
                </ul>
            </div>
        </div>
        ...
        <div class="bottom-data">
            ...
            <div class="add-model">
               ...
               <div class="header">
                ...
                <form class="form" method="post" action="<?php echo URLROOT; ?>/storemanager/addCategory">
