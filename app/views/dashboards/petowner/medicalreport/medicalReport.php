            ...
            <div class="header">
                <div class="left">
                    ...
                    <ul class="breadcrumb">
                        ...
                        >
                        <li><a href="<?php echo URLROOT;?>/petowner/medicalreport" class="active">Medical Report</a></li>
                    </ul>
                </div>
                    ...
                    <table>
                        <thead>
                            <tr>
                                ...
                                <th>Visit Date <i class='bx bxs-sort-alt sort' data-sort="date-search"></th>
                                <th>Diagnosis <i class='bx bxs-sort-alt sort' data-sort="diagnosis-search"></th>
                                <th>Follow-up-Date <i class='bx bxs-sort-alt sort' data-sort="followup-search"></th>
                        ...
                        <?php
                                ...
                                foreach($data['medicalreport'] as $medicalreport) : ?>

<tr>
                                <td class="id-search">TRT-<?php echo $medicalreport->treatment_id?></td>
                                <td class="profile">
                                ...
                                <td class="date-search"><?php echo $medicalreport->visit_date?></td>
                                <td class="diagnosis-search"><?php echo $medicalreport->diagnosis?></td>
                                <td class="followup-search"><?php echo $medicalreport->followup_date !== null ? $medicalreport->followup_date : '----------'; ?></td>
                                ...
                                <td class="action">
                                    <div class="act-icon">
                                        <a href="<?php echo URLROOT;?>/petowner/showMedicalReport/<?php echo $medicalreport->treatment_id; ?>"><i class='bx bx-show' ></i></a>
                                    </div>
                                </td>
