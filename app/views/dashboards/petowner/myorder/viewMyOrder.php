...
<?php include __DIR__ . '/../../common/dashboard-top-side-bar.php'; ?>
        ...
        <main>
            <div class="header">
                <div class="left">
                    ...
                    <ul class="breadcrumb">
                        ...
                        >
                        <li><a href="<?php echo URLROOT;?>/petowner/myorders" >My Orders</a></li>
                        >
                        <li><a href="<?php echo URLROOT;?>/petowner/myorders" class="active">View My Orders</a></li>
                    </ul>
                </div>
            ...
            <table id="invoice-table" style="max-width:670px;margin:50px auto 10px;background-color:#fff;padding:50px;-webkit-border-radius:3px;-moz-border-radius:3px;border-radius:3px;-webkit-box-shadow:0 1px 3px rgba(0,0,0,.12),0 1px 2px rgba(0,0,0,.24);-moz-box-shadow:0 1px 3px rgba(0,0,0,.12),0 1px 2px rgba(0,0,0,.24);box-shadow:0 1px 3px rgba(0,0,0,.12),0 1px 2px rgba(0,0,0,.24); border-top: solid 10px green;">
                ...
                <tr>
                    ...
                    <p style="font-size:14px;margin:0 0 6px 0;"><span style="font-weight:bold;display:inline-block;min-width:146px">Invoice ID</span><?php echo $data['cartDetails'] -> invoice_id ?></p>
                    <p style="font-size:14px;margin:0 0 0 0;"><span style="font-weight:bold;display:inline-block;min-width:146px">Order amount</span>LKR <?php echo $data['cartDetails'] -> total_price ?></p>
                    </td>
                </tr>
                <tr>
                    <td style="height:35px;"></td>
                ...
                <tr>
                    ...
                    <?php foreach($data['products'] as $item) : ?>
                        ...
                        <span style="display:block;font-size:13px;font-weight:normal;"><?php echo $item->name ?></span> LKR <?php $price = $item->price * $item->ordered_quantity; echo $price; ?> <b style="font-size:12px;font-weight:300;">| Quantity - <?php echo $item->ordered_quantity ?> | Unit Price - LKR <?php echo $item->price ?></b>
                    </p>
    ...
    const filename = '<?php echo $_SESSION['user_fname'] ?>' + ' - ' + 'invoiceID-<?php echo $data['cartDetails'] -> invoice_id ?>' + '.pdf';
