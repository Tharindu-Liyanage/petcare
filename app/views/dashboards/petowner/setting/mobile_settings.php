...
<html lang="en">
   ...
   <?php include __DIR__ . '/../../common/dashboard-top-side-bar.php'; ?>
                        ...
                        <div class="header">
                            <div class="left">
                                ...
                                <ul class="breadcrumb">
                                    ...
                                    >
                                    <li><a href="<?php echo URLROOT?>/petowner/settings/mobile" class="active"> Change Mobile Number</a></li>
                                </ul>
                            </div>
        ...
        <form class="container"   method="POST" action="<?php echo URLROOT?>/petowner/settings/mobile" id="myForm">     <!--start of form-->
                                        ...
                                        <div class="inner-content active">                 <!-- start of inner content1 (Myprofile)-->
                                            <div class="personal-info">                 <!-- personal info-->
                                                ...
                                                <div class="line2">
                                                    ...
                                                    <button type="reset" class="cancel-btn" onclick="window.location.href = '<?php echo URLROOT; ?>/petowner/settings/mobile';">Cancel</button>
