        ...
        <form class="container" >     <!--start of form-->
            ...
            <!-- ancor tag for each account setting -->
                <div class="setting-list">
                    ...
                    <a href="<?php echo URLROOT; ?>/nurse/settings/profile"> 
                    ...
                    <a href="<?php echo URLROOT; ?>/nurse/settings/password"> 
                    ...
                    <a href="<?php echo URLROOT; ?>/nurse/settings/email"> 
                    ...
                    <a href="<?php echo URLROOT; ?>/nurse/settings/mobile"> 
