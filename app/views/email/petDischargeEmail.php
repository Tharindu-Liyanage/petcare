    ...
    <! Banner -->
      ...
      <! First Row -->
        <table role="presentation" border="0" cellpadding="0" cellspacing="10px" style="padding: 30px 30px 0 60px;">
          <tr>
            <td>
              <h2 align="center">Pet Discharge From PetCare 🐶</h2>
              <p align="left"> Hi, <b>{pet_owner_fname}</b>
                <b>{pet_owner_lname}</b>
              </p>
              <p align="left"> We are delighted to inform you that your pet, <b>{pet}</b>, is ready to be discharged from our care at PetCare Vet Clinic. <b>{pet}</b> has recovered well from the recent treatment/procedure, and we are confident that <b>{pet}</b> is ready to return home to you. </p>
          ...
          <table width="100%" role="presentation" border="0" cellpadding="0" cellspacing="10px" width="500px" style="padding: 0px 30px 30px 60px;">
            ...
            <tr>
              <td align="center" style="padding: 30px 30px;">
                <button>
                  <a style="text-decoration:none; color:#fff" href="http://localhost/petcare/petowner/animalward">Check Pet treatment Details</a>
                </button>
              </td>
            </tr>
          </table>
