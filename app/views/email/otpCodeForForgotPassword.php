...
<body bgcolor="#F5F8FA" style="width: 100%; margin: auto 0; padding:0; font-family: &quot;Poppins&quot;, sans-serif; font-size:18px; color:#33475B; word-break:break-word">
    ...
    <table role="presentation" border="0" cellpadding="0" cellspacing="10px" style="padding: 30px 30px 0 60px;">
        <tr>
            <td>
                <h2 align="center">Password Reset OTP - PetCare </h2>
                <p align="left"> Hi, <b>{pet_owner_fname}</b>
                    <b>{pet_owner_lname}</b>
                </p>
                <p align="left"> You've requested to reset your password. To complete this process, please use the following One-Time Password (OTP) code </p>
                <p align="left"> This OTP is valid for the next 5 minutes. If you didn't request a password reset, please ignore this email. </p>
