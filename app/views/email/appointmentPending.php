        ...
        <table role="presentation" border="0" cellpadding="0" cellspacing="10px" style="padding: 30px 30px 0 60px;">
          <tr>
            <td>
              ...
              <p align="left"> Hi, <b> <?php echo $_SESSION['user_fname'];?> </b> <?php echo ' 
															<b>' . $_SESSION['user_lname'];?></b>
              </p>
              <p align="left"> We wanted to inform you that your payment has been successfully received. Your appointment is currently <b>pending</b> confirmation, and we will notify you as soon as it is accepted. </p>
            ...
            <tr>
              <td align="center" style="padding: 30px 30px; text-align: center;">
                ...
                <ul style="padding: 0; list-style-type: none; text-align: left; display: inline-block; margin: 0;">
                  <li class="aid">
                    <span class="list">Appointment ID</span> : <?php echo $_SESSION['appointment_generatedID'];?>
                  </li>
                  <li class="vet">
                    <span class="list">Veterinarian</span> : <?php echo $_SESSION['appointment_vetFname'];?> <?php echo $_SESSION['appointment_vetLname'];?>
                  </li>
                  <li class="pet">
                    <span class="list">Pet</span> : <?php echo $_SESSION['appointment_petName'];?>
                  </li>
                  <li class="date">
                    <span class="list">Date</span> : <?php echo $_SESSION['appointment_date'];?>
                  </li>
                  <li class="time">
                    <span class="list">Time</span> : <?php echo $_SESSION['appointment_time'];?>
                  </li>
                  <li class="tid">
                    <span class="list">Treatment</span> : <?php if($_SESSION['appointment_treatment'] =="NONE"){echo "New Treatment"; }else{ echo $_SESSION['appointment_treatment'];}?>
                  </li>
                  <li class="reason">
                    <span class="list">Reason</span> : <?php echo $_SESSION['appointment_reason'];?>
                  </li>
                  <li class="status">
                    <span class="list">Status</span> : <b>Pending</b>
                  </li>
                </ul>
              </td>
            </tr>
