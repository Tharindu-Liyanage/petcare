<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional //EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
                    ...
                    <body bgcolor="#F5F8FA" style="width: 100%; margin: auto 0; padding:0; font-family: &quot;Poppins&quot;, sans-serif; font-size:18px; color:#33475B; word-break:break-word">
                        ...
                        <table role="presentation" border="0" cellpadding="0" cellspacing="10px" style="padding: 30px 30px 0 60px;">
                            <tr>
                                <td>
                                    <h2 align="center">Heads up! Tomorrow's the purrfect day for your pet's appointment!</h2>
                                    <p align="left">
                                        Hi, <b>{pet_owner_fname}</b> <b>{pet_owner_lname}</b>
                                    </p>
                                    <p align="left">
                                    We hope this message finds you and your furry friend <b>{pet_name}</b> in good health! This is a friendly reminder about your upcoming pet care appointment tomorrow.
                                    </p>
                                    <p align="left">
                                        If you need to reschedule or have any questions, please don't hesitate to contact us or reply to this email.
                                    </p>
                        ...
                        <img class="app-img" alt="booking" src="https://i.ibb.co/yhNTM6M/undraw-beach-day-cser.png" >
                        
                    
                        <ul style="padding: 0; list-style-type: none; text-align: left; display: inline-block; margin: 0;">
                            
                            <li class="aid"> <span class="list">Appointment ID</span> :{appointment_id} </li>
                            <li class="vet"> <span class="list">Veterinarian</span> : {vet_name}</li>
                            <li class="pet"> <span class="list">Pet</span> : {pet_name}</li>
                            <li class="date"> <span class="list">Date</span> : {appointment_date}</li>
                            <li class="time"> <span class="list">Time</span> : {appointment_time}</li>
                            <li class="reason"> <span class="list">Reason</span> : {appointment_reason}</li>
                            <li class="tid"> <span class="list">For</span> : {treatment_id}</li>
                            <li class="status"> <span class="list">Status</span> : <b>{appointment_status}</b></li>
                        </ul>
                    </td>
