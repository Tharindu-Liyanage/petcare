        ...
        <table role="presentation" border="0" cellpadding="0" cellspacing="10px" style="padding: 30px 30px 0 60px;">
          <tr>
            <td>
              ...
              <p align="left"> This is a friendly reminder that your pet, <b>{pet_name}</b>, is scheduled for a follow-up treatment in <b>{day}</b>. Your commitment to your pet's health is appreciated! To ensure the best care for <b>{pet_name}</b>, we encourage you to schedule your appointment now. This will allow you to secure your preferred time and ensure a smooth and timely process. </p>
            ...
            <tr>
              <td align="center" style="padding: 30px 30px; text-align: center;">
                ...
                <ul style="padding: 0; list-style-type: none; text-align: left; display: inline-block; margin: 0;">
                  <li class="tid">
                    <span class="list">Treatment ID</span> :TRT-{treatment_id}
                  </li>
                  <li class="pet">
                    <span class="list">Pet</span> : {pet_name}
                  </li>
                  <li class="date">
                    <span class="list">Follow-Up Date</span> : {follow_up_date}
                  </li>
                  <li class="reason">
                    <span class="list">Follow-Up Reason</span> : {reason}
                  </li>
                </ul>
              </td>
            </tr>
